...
import ru.elnorte.data.movierepository.network.MovieApiService
...
class MovieRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun getTopMovies(): Result<ru.elnorte.core.models.network.TopMoviesTransferModel> {
        return apiService.getTopMovies().safeApiCall()
    }

    override suspend fun getMovieDetails(movieId: Int): Result<ru.elnorte.core.models.network.MovieDetailsTransferModel> {
