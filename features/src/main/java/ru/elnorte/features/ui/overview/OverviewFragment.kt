...
import ru.elnorte.features.databinding.OverviewFragmentBinding
...
class OverviewFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        (requireContext().applicationContext as FeatureComponentProvider).provideFeatureComponent()
            .inject(this)
    }
    ...
    private fun showSuccess(state: OverviewUiState.Success) {
        ...
        binding.topPanel.titleTextView.text = when (state.fragment) {
            MovieListType.FAVORITE -> getString(R.string.favorites_title)
            MovieListType.OVERVIEW -> getString(R.string.popular_title)
        }
    }
