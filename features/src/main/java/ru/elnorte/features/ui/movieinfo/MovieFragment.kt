...
import ru.elnorte.data.models.MovieInfoDataModel
import ru.elnorte.features.R
import ru.elnorte.features.databinding.MovieinfoFragmentBinding
...
class MovieFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        (requireContext().applicationContext as FeatureComponentProvider).provideFeatureComponent().inject(this)
    }
